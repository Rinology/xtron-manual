...
export default function BatteryKTX6pinGuide() {
  const itemVariants = {
  ...
  return (
    <section id="battery-ktx-6pin" style={{ marginBottom: '4rem', paddingTop: '1rem' }}>
      ...
      >
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <h5 style={{ color: 'var(--ci-primary)', fontSize: '1.1rem', margin: 0, fontWeight: 700 }}>KTX 배터리 탈착 가이드 (6핀)</h5>
        </div>
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', margin: 0, lineHeight: 1.6 }}>
          프레임 외부 크래들(거치대)에 탈착되는 <strong>KTX형 외장 배터리 — 6핀 커넥터</strong> 모델의 탈착 방법입니다.<br/>
      ...
      >
        ...
        <div>
          <h4 style={{ color: '#4f46e5', fontSize: '1rem', marginBottom: '0.4rem', fontWeight: 700 }}>6핀 커넥터 식별 방법</h4>
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', margin: 0, lineHeight: 1.6 }}>
            배터리와 프레임이 연결되는 커넥터 내부의 <strong>금속 핀(단자)이 6개</strong> 있으면 이 가이드에 해당합니다.<br/>
            (사진 자리에 6핀 커넥터 확대 사진을 삽입해 주세요.)
          </p>
          <Zoom>
            <img
              src="https://placehold.co/600x300?text=6핀+커넥터+식별+사진"
              alt="6핀 커넥터 식별"
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <motion.div variants={itemVariants} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-50px' }} className="glass-panel guide-step-panel" style={{ position: 'relative' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '1rem', lineHeight: 1.6 }}>
              내용을 여기에 작성해 주세요.<br/>
              (크래들 삽입 방향, 6핀 커넥터 연결, 잠금 순서 등을 설명하세요.)
            </p>
            <Zoom>
              <img
                src="https://placehold.co/600x400?text=KTX+6핀+배터리+장착+사진"
                alt="KTX 6핀 배터리 장착"
        ...
        <motion.div variants={itemVariants} initial="hidden" whileInView="show" viewport={{ once: true, margin: '-50px' }} className="glass-panel guide-step-panel" style={{ position: 'relative' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem', marginBottom: '1rem', lineHeight: 1.6 }}>
              내용을 여기에 작성해 주세요.<br/>
              (잠금 버튼 누르기 → 6핀 커넥터 분리 → 배터리 슬라이드 분리 순서)
            </p>
            <Zoom>
              <img
                src="https://placehold.co/600x400?text=KTX+6핀+배터리+분리+사진"
                alt="KTX 6핀 배터리 분리"
                style={{ width: '100%', borderRadius: '8px', border: '1px solid var(--surface-border)', maxWidth: '500px', display: 'block', margin: '0 auto' }}
              />
            </Zoom>
